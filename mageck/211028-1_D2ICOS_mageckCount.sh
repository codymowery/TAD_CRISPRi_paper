...
donor=$(awk 'NR==i{print $1}' i=${SGE_TASK_ID} ${script_path}211028-1_D2ICOS_mageckSamplesheet.txt)
target=$(awk 'NR==i{print $2}' i=${SGE_TASK_ID} ${script_path}211028-1_D2ICOS_mageckSamplesheet.txt)
echo ${donor} ${target}

ref=${script_path}UniqueLibraryRef.csv

fq_path=/wynton/group/ye/cody/screens/data/211028-1-5b_211130-1_220102_NB501415_0470_AHNML2AFX2/fastq/211028-1/
...
mageck count -l ${ref} \
 -n ${donor}_${target} \
 --sample-label ${donor}_${target}_LO_reindex,${donor}_${target}_HI_reindex \
